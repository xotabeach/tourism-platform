...
| Толщина | **2 pt** (замер по полувысоте: 2.10) |
| Штрих | **9 pt** |
| Пропуск | **2.6 pt** |
| Период | **11.5 pt** |
| Цвет | **`#1537E7`**, **непрозрачный** |
| Концы штрихов | `butt` (срез, не скругление) |
...
Во Flutter: `CustomPainter`, `Path()..arcTo(...)`, затем нарезка через
`PathMetric.extractPath` шагом 9 / 2.6.
