...
- generated и user_created — `private`;
...
Публикация user_created маршрутов — Future. До этого пользовательские маршруты
остаются private. Editorial публикует редакция без пользовательской модерации.

## 12. Будущие достижения

Бейджи, стрики, уровни — Future. Не входят в MVP и не блокируют core flows.
