...
| --- | --- |
| нет названия | нет своей фотографии — подставится общая через `generic_fallback_cover` |
...
**Замер 2026-08-24:** готовы **144** места, заблокированы 4824 из-за
отсутствия содержательного текста и 700 без привязки к городу. Медиана
длины OSM-описания — 9 символов (геодезические маркеры «МК-29»),
поэтому 786 мест с непустым `description` дают лишь 144 пригодных.
