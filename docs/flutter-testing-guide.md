...
The 2026-08-26 merge validation passed format, strict analysis, **245 tests
and 25 macOS pixel goldens**. (For historical reference: the 2026-07-25
remediation run had 54 tests.) Five compositor-related baselines were accepted only
